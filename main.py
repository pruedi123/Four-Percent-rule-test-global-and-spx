...
with st.expander("Advanced options"):
    start_row = st.number_input("Begin simulation row index--28 is Global Depression era and 452 is mid-1960's Begin", min_value=0, max_value=max(0, len(df) - 1), value=28, step=1)
